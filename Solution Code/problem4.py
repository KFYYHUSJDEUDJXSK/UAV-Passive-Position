...
index_launch[3,:] = np.array([7,5,13])

index_launch[1,:] = np.array([4,9,3])
index_launch[4,:] = np.array([2,6,8])

index_launch[2,:] = np.array([6,8,14])
index_launch[5,:] = np.array([5,10,13])

index_measure = np.zeros((6,3))
index_measure[0,:] = np.array([7,5,13])
index_measure[3,:] = np.array([4,9,12])

index_measure[1,:] = np.array([2,6,8])
index_measure[4,:] = np.array([4,9,3])

index_measure[2,:] = np.array([5,10,13])
